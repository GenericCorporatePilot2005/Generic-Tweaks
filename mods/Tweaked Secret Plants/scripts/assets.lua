...
if spritesChili==2 then
    ...
    modApi:appendAsset("img/portraits/pilots/Pilot_lmn_Chili.png", path .."img/portraits/chilialt1.png")--alpha chili's pilot
...
elseif spritesChili==3 then
    ...
    modApi:appendAsset("img/portraits/pilots/Pilot_lmn_Chili.png", path .."img/portraits/chilialt2.png")--Leader chili's pilot
...
--Chomper
    ...
    if spritesChomper==2 then
        ...
        modApi:appendAsset("img/portraits/pilots/Pilot_lmn_Chomper.png", path .."img/portraits/chomperalt1.png")--alpha Chomper's pilot
    ...
    elseif spritesChomper==3 then
        ...
        modApi:appendAsset("img/portraits/pilots/Pilot_lmn_Chomper.png", path .."img/portraits/chomperalt2.png")--Leader Chomper's pilot
